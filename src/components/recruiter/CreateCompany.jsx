        ...
        <div>
            <div className='max-w-4xl mx-auto'>
                ...
                <div className='flex items-center gap-2 my-10'>
                    ...
                    {
                        loading ? <Button className='border bg-purple-800 text-white'>Creating<Loader2 className=" mr-2 h-4 w-4 animate-spin" /></Button> : <Button onClick={registerNewCompany} className='border bg-purple-700 text-white'>Continue</Button>
                    }
                </div>
            </div>
        </div>
